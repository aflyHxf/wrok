...
(function () {
  ...
  angular
    ...
    .controller('PartnerRealtimeController', PartnerRealtimeController);

  /** @ngInject */
  function PartnerRealtimeController($log, $rootScope, $state, $window, $filter, jQ, localStorage, player, partner, pagination, common) {
    var vm = this;
    ...
    partner.on('getPartnerCommission',function(data){
      ...
      if(data.data){
        ...
        for(var commission in data.data){
            vm.subTotalBonusAmount += data.data[commission].totalBonusAmount;
            vm.subServiceFee += data.data[commission].serviceFee;
            vm.subPlatformFee += data.data[commission].platformFee;
            vm.subProfitAmount += data.data[commission].profitAmount;
        }
        vm.partnerCommissionStats = data.data.stats.totalCount;
