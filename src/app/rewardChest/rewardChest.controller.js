...
(function () {
  ...
  angular
    ...
    .controller('RewardChestController', RewardChestController);

  /** @ngInject */
  function RewardChestController(reward, platformId, localStorage, $state) {
    var vm = this;
    vm.topupRewardInfo = {};
    vm.RewardStatus = {
      '0':'未达成',
    ...
    reward.emit("getSlotInfo", {platformId: platformId, code: "bxxhl"});
